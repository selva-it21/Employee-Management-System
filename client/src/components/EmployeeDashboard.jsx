...
import { CalendarIcon, DollarSign, FileText, ArrowRight } from 'lucide-react';
    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
            <Link to="/attendance" className="btn-primary inline-flex items-center justify-center gap-2 text-center"> Mark Attendance

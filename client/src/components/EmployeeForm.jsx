  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
        ...
        <div className="card p-5 sm:p-6">
            <h3 className="font-medium mb-6 pb-4 border-b border-slate-100">Personal info</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                ...
                <div className="sm:col-span-2">
                    ...
                    <input name="bio" defaultValue={initialData?.bio} rows={3} className="resize-none" placeholder="Breif description...." />
                </div>
            </div>
        </div>
        ...
        {/* Emplyment Details */}
        <div className="card p-5 sm:p-6">
            <h3 className="text-base font-medium text-slate-900 mb-6 pd-4 border-b border-slate-100">
                Employee Details
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="deductions" required min="0" step="0.01" defaultValue={initialData?.allowances || 0} />
                </div>
                <div>
                ...
                {isEditMode && (
                    <div>
                        ...
                        <select name="employmentStatus" defaultValue={initialData?.emplymentStatus}>
        ...
        {/* Account Setup */}
        <div className="card p-5 sm:p-6">
            <h3 className="font-base font-medium mb-6 pb-4 border-b border-slate-100">Account Setup</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                <div className="sm:col-span-2">
